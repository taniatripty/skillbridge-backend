...
router4.get("/popular", tutorController.getPopularTutors);
router4.get("/:tutorId", tutorController.getTutorById);
router4.get("/", tutorController.getAllTutors);
var tutotRoutes = router4;
